...
stundenlohn = float(input(f"Wie viel verdienst du pro Stunde in CHF? "))
arbeitsstunden = float(input(f"Wie viele Stunden hast Du auf dem Projekt {projekt} gearbeitet? "))
